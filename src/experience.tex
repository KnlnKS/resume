...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Designed an encryption scheme to store the sensitive data of over 100 million users on AWS and GCP}
        \resumeItem{Created a microservice that handles over 1.7 million requests per day with gRPC and Golang}
        \resumeItem{Added functionality to a core utility used across the organization by multiple services}
    \resumeItemListEnd
